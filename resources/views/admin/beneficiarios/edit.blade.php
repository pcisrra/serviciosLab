...
<div class="card">
    <div class="card-header">
        {{ trans('global.edit') }} {{ trans('cruds.beneficiario.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.beneficiarios.update", [$beneficiario->id]) }}" enctype="multipart/form-data">
            @method('PUT')
            @csrf
            <div class="form-group">
                <label class="required" for="ci">{{ trans('cruds.beneficiario.fields.ci') }}</label>
                <input class="form-control {{ $errors->has('ci') ? 'is-invalid' : '' }}" type="text" name="ci" id="ci" value="{{ old('ci', $beneficiario->ci) }}" required>
                @if($errors->has('ci'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('nombres') ? 'is-invalid' : '' }}" type="text" name="nombres" id="nombres" value="{{ old('nombres', $beneficiario->nombres) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('ap_paterno') ? 'is-invalid' : '' }}" type="text" name="ap_paterno" id="ap_paterno" value="{{ old('ap_paterno', $beneficiario->ap_paterno) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('ap_materno') ? 'is-invalid' : '' }}" type="text" name="ap_materno" id="ap_materno" value="{{ old('ap_materno', $beneficiario->ap_materno) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('fecha_nacimiento') ? 'is-invalid' : '' }}" type="text" name="fecha_nacimiento" id="fecha_nacimiento" value="{{ old('fecha_nacimiento', $beneficiario->fecha_nacimiento) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('edad') ? 'is-invalid' : '' }}" type="number" name="edad" id="edad" value="{{ old('edad', $beneficiario->edad) }}" step="1">
                @if($errors->has('edad'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('correo') ? 'is-invalid' : '' }}" type="text" name="correo" id="correo" value="{{ old('correo', $beneficiario->correo) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('celular') ? 'is-invalid' : '' }}" type="text" name="celular" id="celular" value="{{ old('celular', $beneficiario->celular) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('zona_domicilio') ? 'is-invalid' : '' }}" type="text" name="zona_domicilio" id="zona_domicilio" value="{{ old('zona_domicilio', $beneficiario->zona_domicilio) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('ocupacion') ? 'is-invalid' : '' }}" type="text" name="ocupacion" id="ocupacion" value="{{ old('ocupacion', $beneficiario->ocupacion) }}">
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('tipo_beneficiario') ? 'is-invalid' : '' }}" name="tipo_beneficiario" id="tipo_beneficiario" required>
                    ...
                    @foreach(App\Beneficiario::TIPO_BENEFICIARIO_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('tipo_beneficiario', $beneficiario->tipo_beneficiario) === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
